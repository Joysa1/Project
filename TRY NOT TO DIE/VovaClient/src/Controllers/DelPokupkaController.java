...
public class DelPokupkaController {
    ...
    void initialize() {
        ...
        {
            DeletePokupka pokupka = new DeletePokupka();
            Pokupka newpokupka = new Pokupka();
            TableView.TableViewSelectionModel<Pokupka> selectionModel = table.getSelectionModel();
            if(!selectionModel.isEmpty()) {
                Pokupka selectedItem = selectionModel.getSelectedItem();
                newpokupka.setId(selectedItem.getId());
                newpokupka.setIdtovara(selectedItem.getIdtovara());
                pokupka.setPokupka(newpokupka);
